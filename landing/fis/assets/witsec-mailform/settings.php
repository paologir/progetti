...
$_SETTINGS = [
	"to"						=> "gironipaolo@gmail.com",							// To Address
	"toAlt"						=> "",						// Additional Recipients
	"from"						=> "paolo@gironi.it",						// From Address
	...
	"template"					=> "Salve,<br><br>Avete ricevuto un nuovo contatto dalla landing page<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>Buona giornata.",					// Mail Template
